...
@frappe.whitelist()
def send_document(to, file_url, caption=None, filename=None):
    """
    Send WhatsApp document - SIMPLE VERSION

    Args:
        to: Phone number (e.g., "256757001909")
        file_url: COMPLETE public URL (e.g., "https://yoursite.com/files/invoice.pdf")
    ...
    try:
        ...
        frappe.log_error(str(e), "WhatsApp Document")
        return {"success": False, "error": str(e)}
